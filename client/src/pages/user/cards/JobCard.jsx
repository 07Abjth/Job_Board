...
export const JobCard = ({ job, userBookmarks = [], onBookmarkAdd, onBookmarkRemove }) => {
  ...
  return (
    <div className="relative border p-4 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300 bg-white group">
      ...
      <div className="flex justify-between items-center mt-3">
        <Link
          ...
          className="text-sm text-blue-600 font-medium border border-blue-600 px-3 py-1 rounded-full hover:bg-blue-50 transition"
        >
          View Details
        </Link>
